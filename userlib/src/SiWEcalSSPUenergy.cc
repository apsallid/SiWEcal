#include "SiWEcalSSPUenergy.hh"
#include <sstream>
#include <iostream>
#include <cmath>

SiWEcalSSPUenergy::SiWEcalSSPUenergy(const std::string filePath){
...
SiWEcalSSPUenergy::~SiWEcalSSPUenergy(){
}

double SiWEcalSSPUenergy::getDensity(const double & eta, const unsigned layer, const double & cellSizeincm, const unsigned PU) const{
