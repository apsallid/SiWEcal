#ifndef _siwecalssrecojet_hh_
#define _siwecalssrecojet_hh_
...
public:
  ...
  SiWEcalSSRecoJet(const double & px, const double & py, const double & pz, const double & E);
...
private:
  ...
  ClassDef(SiWEcalSSRecoJet,1);

};


typedef std::vector<SiWEcalSSRecoJet> SiWEcalSSRecoJetVec;
