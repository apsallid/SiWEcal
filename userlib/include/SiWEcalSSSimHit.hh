#ifndef _siwecalsssimhit_hh_
#define _siwecalsssimhit_hh_
...
public:
  ...
  SiWEcalSSSimHit(const G4SiHit & aSiHit, const unsigned & asilayer, const float cellSize = CELL_SIZE_X);
...
typedef std::vector<SiWEcalSSSimHit> SiWEcalSSSimHitVec;
