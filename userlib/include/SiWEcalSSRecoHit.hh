#ifndef _siwecalssrecohit_hh_
#define _siwecalssrecohit_hh_
...
public:
  ...
  SiWEcalSSRecoHit(const SiWEcalSSSimHit & aSimHit, const unsigned granularity=1);
  ...
  void Add(const SiWEcalSSSimHit & aSimHit);
...
private:
  ...
  ClassDef(SiWEcalSSRecoHit,1);

};


typedef std::vector<SiWEcalSSRecoHit> SiWEcalSSRecoHitVec;
