#ifndef _siwecalssgenparticle_hh_
#define _siwecalssgenparticle_hh_
...
private:
  ...
  ClassDef(SiWEcalSSGenParticle,1);
...
typedef std::vector<SiWEcalSSGenParticle> SiWEcalSSGenParticleVec;
